...
export const HeroSection = () => {
  ...
  <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
    ...
    <HeroOrbit size={590} rotation={98} shouldOrbit spinDuration="41s">
       <StarIcon className="size-8 text-emerald-300" />
      </HeroOrbit>
      <HeroOrbit size={650} rotation={-5} shouldOrbit spinDuration="52s">
        <div className='size-3 rounded-full bg-emerald-300/20'></div>
      </HeroOrbit>

      
    <HeroOrbit size={710} rotation={144} shouldOrbit spinDuration="64s">
       <SparkleIcon className="size-14 text-emerald-300/20" />
      </HeroOrbit>

      <HeroOrbit size={720} rotation={85} shouldOrbit spinDuration="80s">
        <div className='size-3 rounded-full bg-emerald-300/20'></div>
      </HeroOrbit>
      
      
      <HeroOrbit size={800} rotation={-72} shouldOrbit spinDuration="100s" shouldSpin>
